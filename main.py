...
class ORIONAdvancedVLM:
    def __init__(self, config=Config()):
        ...
        print("🚀 ORION Advanced VLM System Initialized")
    
    def start(self):
        """Start the advanced VLM system"""
        print("=" * 70)
        print("🤖 ORION ADVANCED VLM - Scene Understanding System")
        print("=" * 70)
        ...
        if self.speech_processor.has_microphone:
            print("🎤 Voice: ENABLED - Say 'ORION' followed by your question")
    ...
    def _speech_worker(self):
        ...
        print("🎤 Speech worker started - Listening for wake word 'ORION'...")
    ...
    def _display_loop(self):
        ...
        while self.is_running:
            ...
            cv2.putText(display_frame, "ORION ADVANCED VLM - Press Q to quit | SPACE for voice", 
        ...
        print("👋 ORION Advanced VLM shutdown complete")
...
def main():
    ...
    try:
        print("🤖 Starting ORION Advanced VLM System...")
        app = ORIONAdvancedVLM()
        app.start()
        ...
        print("🎯 Thank you for using ORION Advanced VLM!")
